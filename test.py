...
with st.form("style_quiz"):
    ...
    q2 = st.radio("Q2：你平常穿衣服的尺寸是？", 
                  ["A. XS / S", 
                   "B. M", 
                   "C. L", 
                   "D. XL / 以上"])
    
    q3 = st.radio("Q3：如果讓你自己量一下肩膀的寬度，你猜大概是？",
                  ["A. 小於 38cm（肩膀比較窄）",
                   "B. 38～39.5cm（中等）",
                   "C. 39.5～41cm（偏寬）",
                   "D. 超過 41cm（寬肩代表）"])
    
    q4 = st.radio("Q4：以下哪種描述最符合你的身形？", 
                  ["A. 肩膀窄、骨架小", 
                   "B. 整體比例平均", 
                   "C. 上半身稍寬", 
                   "D. 身高比較高 / 四肢修長"])
    
    q5 = st.radio("Q5：你最常穿的衣服版型是？", 
                  ["A. 合身剪裁", 
                   "B. 微寬鬆", 
                   "C. 完全寬鬆", 
                   "D. 看心情"])

    q6 = st.radio("Q6：你穿 T-shirt 或上衣最在意什麼？", 
                  ["A. 領口不能太高或太低", 
                   "B. 袖長要剛剛好", 
                   "C. 衣長要能遮部位", 
                   "D. 材質舒服就好"])

    submitted = st.form_submit_button("看結果")
